...
public class MesPieces implements Serializable {
    ...
    /**
     * Contructeur de MesPieces
     * 
     * @param c
     */

    public MesPieces(boolean c) {
        this.color = c;
        this.k = new King();
        this.q = new Queen();
    ...
    /**
     * Méthode pour initialiser les piéces
     */
    ...
    public void init() {
        if (this.getColor()) {
            ...
            System.out
                    .println("Vous n'avez pas choisit une bonne couleur.\nVeillez choisir entre soit blanc soit noir.");
            this.init();
        }
        this.initMesPieces();
    }
    ...
    /**
     * Méthode pour prendre une piéce d'une arraylist avec son id
     * 
     * @param ps => L'arrayList de piece
     * @param id => M'identifiant de la piéce
     * @return => Une piéce
     */
